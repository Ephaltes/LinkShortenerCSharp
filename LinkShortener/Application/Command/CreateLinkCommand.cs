...
{
    public class CreateLinkCommand : IRequest<CustomResponse<string>>
    {
        ...
        public bool CustomSluge { get; set; }
        ...
        private string RandomString(int minlength=4,int maxlength=8)
        {
